...
namespace NaughtyAttributes.Editor
{
    ...
    public static class SpecialCaseDrawerAttributeExtensions
    {
        ...
        static SpecialCaseDrawerAttributeExtensions()
        {
            ...
            _drawersByAttributeType[typeof(GUIReordListAttribute)] = ReorderableListPropertyDrawer.Instance;
        }

        public static SpecialCasePropertyDrawerBase GetDrawer(this SangoGUIDrawerSpecialAttribute attr)
        {
